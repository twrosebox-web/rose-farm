...
window.DATA.modalContent = {
    ...
    'modal-picking': { layout: 'rich', title: "有機玫瑰採摘", tags: ["親子"], stats: [{ icon: "🕒", label: "開放", value: "09-16時" }, { icon: "⚖️", label: "費用", value: "20元/朵" }, { icon: "🌹", label: "品種", value: "大花玫瑰" }], desc: "戴上斗笠、提起竹籃，親手摘下清晨最鮮嫩的有機玫瑰。這是與土地最親密的接觸。", highlights: ["現採現算", "採花不採枝", "帶回家泡花茶、入料理"], images: ["https://i.meee.com.tw/wSB3Ewd.webp","https://i.meee.com.tw/whdCubC.webp","https://i.meee.com.tw/5ETxYoD.webp","https://i.meee.com.tw/KWcf357.webp","https://i.meee.com.tw/JPyCKoC.webp"] },
    ...
    'modal-diy-dye': { layout: 'rich', title: "花壽司 DIY", tags: ["親子", "料理"], stats: [{ icon: "⏱️", label: "時長", value: "?分鐘" }, { icon: "💰", label: "費用", value: "$320/人" }, { icon: "🍙", label: "成團", value: "15人" }], desc: "將有機食用玫瑰花瓣融入壽司米中，捲出色彩繽紛的創意花壽司。", highlights: ["食用花入菜", "清爽低卡料理", "適合親子同樂"], images: ["https://images.unsplash.com/photo-1452860606245-08befc0ff44b?w=800&q=80"] },
